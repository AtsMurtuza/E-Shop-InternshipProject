<div class="col-xs-10 col-xs-offset-1" style="height:600px;padding-left:100px;top:225;">
	<form id="InitRegistration">
		...
		<div class="form-group col-xs-3">
			<button type="button" name="InitRegistrationSubmit" id="InitRegistrationSubmit" disabled class="btn btn-success btn-lg">Register</button>
		</div>

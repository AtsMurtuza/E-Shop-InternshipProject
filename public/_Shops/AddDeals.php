<html>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
		 ...
		 <form id="AddCouponForm" class="horizontal-form" role="form" method="post" action="../../controller/AddDeals.php">
			<div class="col-md-12">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h4 style="text-align:center">Add a New deal</h4>
					</div>
					<div class="panel-body">		
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="dropdown">BUY </label>
								<input type="textbox" placeholder="Buy Value" name="buyvalue" id="buyvalue" class="form-control" required>							</div>
						</div>	
						
						<div class="col-md-3">
							<div class="form-group">
								<label for="dropdown"> Get <span class="fa fa-rupee"></span></label>
								<input type="textbox" placeholder="Get Value" name="getvalue" id="getvalue" class="form-control" required>
							</div>
						</div>	
						<div class="col-md-3">
							<div class="form-group">
